...
int main(int argc, char** argv)
{
    try
    {
        int qLength1, qLength2, i, element;
        cout << "Enter the length of 1st queue: " << endl;
        cin >> qLength1;
        Queue<int>* q1 = new Queue<int>();
        for (i = 0; i < qLength1; i++)
        {
        ...
        cin >> stNumbers;
        int id[2*stNumbers];
        for (i = 0; i < 2 * stNumbers; i+=2)
        {
            cout << "Enter the 1st number for id of " << i / 2 + 1 << " student: " << endl;
            cin >> id[i];
            cout << "Enter the 2nd number for id of " << i / 2  + 1 << " student: " << endl;
            cin >> id[i + 1];
            StudentID* id1 = new StudentID(id[i], id[i + 1]);
            string firstName;
            cout << "Enter the first name of " << i / 2 + 1 << " student:" << endl;
            cin >> firstName;
            string* pFirstName = new string(firstName);
            string lastName;
            cout << "Enter the last name of " << i / 2 + 1 << " student:" << endl;
            cin >> lastName;
            string* pLastName = new string(lastName);
            Student* s1 = new Student(id1, pFirstName, pLastName);
            qStudent->Push(s1);
        }
        cout << "Queue of students is ready" << endl;
        cout << "Length of queue of students: " << qStudent->Size() << endl;
        cout << "Front element of queue of students: " << *(qStudent->Front()->GetFirstName()) << " " << *(qStudent->Front()->GetLastName()) << endl;
        cout << "Back element of queue of students: " << *(qStudent->Back()->GetFirstName()) << " " << *(qStudent->Back()->GetLastName()) << endl;
        cout << " " << endl;

        int sLength1, sLength2;
        cout << "Enter the length of 1st stack: " << endl;
        cin >> sLength1;
        Stack<int>* s1 = new Stack<int>();
        for (i = 0; i < sLength1; i++)
        {
        ...
        Stack<Student*>* stStudent = new Stack<Student*>();
        int stNumbers2;
        cout << "Enter the number of students: " << endl;
        cin >> stNumbers2;
        int id2[2*stNumbers2];
        for (i = 0; i < 2 * stNumbers2; i+=2)
        {
            cout << "Enter the 1st number for id of " << i / 2 + 1 << " student: " << endl;
            cin >> id2[i];
            cout << "Enter the 2nd number for id of " << i / 2  + 1 << " student: " << endl;
            cin >> id2[i + 1];
            StudentID* idStack = new StudentID(id2[i], id2[i + 1]);
            string firstName;
            cout << "Enter the first name of " << i / 2 + 1 << " student:" << endl;
            cin >> firstName;
            string* pFirstName = new string(firstName);
            ...
            cin >> lastName;
            string* pLastName = new string(lastName);
            Student* s1 = new Student(idStack, pFirstName, pLastName);
            stStudent->Push(s1);
        }
        cout << "Stack of students is ready" << endl;
        cout << "Length of stack of students: " << stStudent->Size() << endl;
        cout << "Top element of stack of students: " << *(stStudent->Top()->GetFirstName()) << " " << *(stStudent->Top()->GetLastName()) << endl;
        cout << " " << endl;

        int vLength1, vLength2, index;
        cout << "Enter the length of 1st vector: " << endl;
        cin >> vLength1;
        int* items1 = new int[vLength1];
        for (i = 0; i < vLength1; i++)
        {
            cout << "Enter the element of 1st vector: " << endl;
            cin >> element;
            items1[i] = element;
        }
        Vector<int>* v1 = new Vector<int>(items1, vLength1);
        cout << "1st vector is ready" << endl;
        cout << "Length of 1st vector: " << vLength1 << endl;
        ...
        Vector<int>* v2 = new Vector<int>(items2, vLength2);
        cout << "2nd vector is ready" << endl;
        cout << "Length of 2nd vector: " << vLength2 << endl;
        ...
        {
            cout << "Invalid sizes of vectors for sum and dot product" << endl;
        }
        else
        {
            cout << "Enter the index of coordinate of sum v1 + v2: " << endl;
            cin >> index;
